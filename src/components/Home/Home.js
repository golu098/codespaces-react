  ...
  useEffect(() => {
    const typeText = () => {
      ...
      if (currentCharIndex < currentPhrase.length) {
        setText(currentPhrase.slice(0, currentCharIndex + 1));
        setCurrentCharIndex(currentCharIndex + 1);
      } else {
        // Phrase is fully typed, move to the next phrase
    ...
    const typingInterval = setInterval(typeText, 150); // Adjust typing speed (e.g., 150ms)
    ...
    <>
      <div className="banner">
        <Container className="h-screen d-flex justify-content-center align-items-center">
          <Row>
            <Col md={6}>
              <div className="text-animation text-sky-500">
                <center>
                  <h3>{text}</h3>
                </center>
              </div>
      ...
      <div className="head2">
        <div className="container">
          <p className="container-title text bg-blue-200">Here are the features</p>
          ...
          <div className="gradient-cards">
            <div className="card">
              <div className="container-card bg-green-box">
                ...
                <p class="card-title">Zero-percent Time Wastage</p>
                <p class="card-description">Implement a seamless online appointment booking system to save customers time by enabling quick and convenient bookings.

                  Provide personalized recommendations based on customer history to help them choose the right services efficiently.
                  Utilize online check-in and queue management to minimize wait times and improve overall salon efficiency.
            ...
            <div className="card">
              <div className="container-card bg-white-box">
                ...
                <p class="card-title">Multi-Diverse Functioning</p>
                <p class="card-description">
                  Implementing multi-functionality in online salon booking allows customers to not only book appointments but also access features like real-time stylist availability, online payments, and personalized recommendations for a seamless and convenient user experience.
                  Our platform thrives on multi-diverse functioning, seamlessly connecting salon owners and customers with a wide array of services and resources.
                </p>
              </div>
            </div>
            ...
            <div className="card">
              <div className="container-card bg-yellow-box">
                ...
                <p class="card-title">Increase Efficiency</p>
                <p class="card-description">
                  Elevate your experience on our platform! Join us to make your salon bookings easier and more efficient. For shop owners, partnering with us means increasing your salon's visibility and clientele, while users enjoy a seamless booking process. Unlock the full potential of your salon with us.
                  Experience the future of online salon booking with our platform, offering innovative features, unparalleled convenience, and a community of satisfied salon owners and customers.
                </p>
            ...
            <div className="card">
              <div className="container-card bg-blue-box">
                ...
                <p class="card-description">
                  Experience the future of salon booking with our platform, where we provide a comprehensive array of services and features that are 11 times more than your typical salon appointment. Enjoy the convenience of scheduling your beauty treatments, accessing expert advice, exclusive deals, and much more, all in one place. Say goodbye to the hassles of traditional salon booking .           </p>
              </div>
            </div>
          </div>
        </div>
